...
enum gba_checksum {
	...
	GBA_BLOCK_EXTRA_DATA_OFFSET = 0x74,
 ...
 */
    struct pk3_marking_t {
        ...
        mixin(bitfields!(ubyte, "circle", 1, ubyte, "square", 1, ubyte,
                "triangle", 1, ubyte, "heart", 1, ubyte, "unused", 4));
 ...
 */
    struct pk3_pokerus_t {
        ...
        mixin(bitfields!(ubyte, "days", 4, ubyte, "strain", 4));
    }
 ...
 */
    struct pk3_pp_up_t {
        ...
        mixin(bitfields!(ubyte, "move_0", 2, ubyte, "move_1", 2, ubyte,
                "move_2", 2, ubyte, "move_3", 2));
 ...
 */
    struct pk3_ribbon_t {
        ...
        mixin(bitfields!(ubyte, "cool_normal", 1, ubyte, "cool_super", 1, ubyte,
                "cool_hyper", 1, ubyte, "cool_master", 1, ubyte, "beauty_normal", 1, ubyte,
                "beauty_super", 1, ubyte, "beauty_hyper", 1, ubyte, "beauty_master", 1, ubyte,
                "cute_normal", 1, ubyte, "cute_super", 1, ubyte, "cute_hyper", 1, ubyte,
                "cute_master", 1, ubyte, "smart_normal", 1, ubyte, "smart_super", 1, ubyte,
                "smart_hyper", 1, ubyte, "smart_master", 1, ubyte, "tough_normal", 1, ubyte,
                "tough_super", 1, ubyte, "tough_hyper", 1, ubyte, "tough_master", 1,
                ubyte, "champion", 1, ubyte, "winning", 1, ubyte, "victory", 1,
                ubyte, "artist", 1, ubyte, "effort", 1, ubyte, "marine", 1,
                ubyte, "land", 1, ubyte, "sky", 1, ubyte, "country", 1, ubyte,
                "national", 1, ubyte, "earth", 1, ubyte, "world", 1));
 ...
 */
                ...
                align(1):
                    ...
                    align(1):
                        ...
                        mixin(bitfields!(ubyte, "level_met", 7, ubyte, "game",
                                4, ubyte, "pokeball", 4, ubyte, "is_ot_female", 1));
                    ...
                    union {
                        ...
                        struct {
                            ...
                            mixin(bitfields!(uint, "unknown2", 30, ubyte,
                                    "is_egg", 1, ubyte, "ability", 1));
    ...
    struct pk3_status_t {
        ...
        mixin(bitfields!(ubyte, "status_sleep", 3, ubyte, "status_poison", 1, ubyte,
                "status_burn", 1, ubyte, "status_freeze", 1, ubyte,
                "status_paralysis", 1, ubyte, "status_toxic", 1));
 ...
 */
    struct gba_trainer_t {
        ubyte[7] name; // (0x0) 7
        ubyte padding0; // (0x7) 8
        //padding
        ubyte gender; // (0x8) 9
        ubyte padding1; // (0x9) 10

        union {
            // note: we have to use ubyte array because struct alignment is messed up with uint
            ubyte[4] trainer_id; // trainer (0xA) 14
            struct {
                ushort tid0;
                ushort tid1;
            }
        ...
        gba_time_t time_played; // time (0xE) 19

        ubyte[3] padding2; // padding 22
    }
}
